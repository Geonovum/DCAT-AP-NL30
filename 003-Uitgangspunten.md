...
DCAT-AP-NL:
- is een verdere specialisatie van [[DCAT-AP-3.0.1]]
- als je voldoet aan DCAT-AP-NL voldoe je ook aan [[DCAT-AP-3.0.1]]
- bevat alle verplichte en aanbevolen eigenschappen [[DCAT-AP-3.0.1]], waarbij de gebruiksvoorwaarden van DCAT-AP-NL gelden
- introduceert geen uitbreidingen, als die al uitgedrukt kunnen worden in [[DCAT-AP-3.0.1]] of [[DCAT-3.0]] ,
tenzij er een hele sterke behoefte / aanleiding toe is, en het [[DCAT-AP-3.0.1]] of [[DCAT-3.0]] vocabulary hierin NIET voorziet
- is zo generiek mogelijk van opzet en ligt zo dicht mogelijk bij [[DCAT-AP-3.0.1]]
